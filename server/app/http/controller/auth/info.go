...
func Info(c *context.Context) {
	...
	c.SuccessWithData("获取成功", sinking_web.H{
		"title": c.GetStringWithDefault(web[constant.WebTitle], "SinKingCloud"),
		"name":  c.GetStringWithDefault(web[constant.WebName], "SinKingCloud"),
		"ui": sinking_web.H{
			"layout":    c.GetStringWithDefault(ui[constant.UiLayout], "top"),
