...
type DNSCredentials struct {
	...
	VolcengineAccessKeyID     string `json:"volcengine_access_key_id"`     // 火山引擎 AccessKey ID
	VolcengineAccessKeySecret string `json:"volcengine_access_key_secret"` // 火山引擎 AccessKey Secret
	BaiduAccessKeyID          string `json:"baidu_access_key_id"`          // 百度智能云 AccessKey ID
	BaiduSecretAccessKey      string `json:"baidu_secret_access_key"`      // 百度智能云 Secret Access Key
}
